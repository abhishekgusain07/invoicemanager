        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-12 text-white">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              InvoiceManager helps freelancers and agencies manage their invoices effortlessly. 
              Track payments, automate follow-ups, and get paid faster.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <p className="text-gray-300 mb-4">
                Be among the first freelancers to experience the easiest way to manage invoices and get paid on time.
              </p>
