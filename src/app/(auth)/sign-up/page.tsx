      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="flex items-center mb-8">
            ...
            <span className="ml-3 text-xl font-semibold text-gray-900">InvoiceManager</span>
          </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-12 text-white">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Transform your invoice management workflow. Start tracking payments, automating follow-ups, and getting paid faster today.
            </p>
            <p className="text-gray-400 mb-12">
              Trusted by 1k+ freelancers and agencies worldwide
            </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Automated reminders and follow-ups</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">75% improvement in payment time</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Clear visibility into cash flow</p>
                  </div>
                </div>
              </div>
            </div>
