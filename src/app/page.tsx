...
const createLazyIcon = (iconName: string) =>
  dynamic(
      ...
      })),
    {
      ssr: false,
      loading: () => (
        <span className="inline-block h-6 w-6 animate-pulse rounded bg-muted" />
      ),
    }
  );
  ...
  const stats = [
    {
      ...
      description: "Average improvement in payment collection time",
    },
    {
      value: "4.2h",
      label: "Time Saved Weekly",
      description: "Per freelancer on invoice management",
    },
    {
      value: "96%",
      label: "Client Satisfaction",
      description: "With automated professional follow-ups",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Smart tracking per company with detailed payment history, behavior patterns, and automated status updates.",
      icon: Users,
      status: "live",
    ...
    },
    {
      ...
      description:
        "Set up recurring invoices and let our system handle automated follow-ups with escalating professional tones.",
      icon: RefreshCw,
      status: "live",
    ...
    },
    {
      ...
      description:
        "Easy setup with popular payment processors. Accept payments directly through your invoices.",
      icon: CreditCard,
      status: "live",
    ...
    },
    {
      ...
      description:
        "Per company access control. Give your team members appropriate permissions for different clients.",
      icon: Shield,
      status: "live",
    ...
    },
    {
      ...
      description:
        "Planned AI tools for intelligent invoice generation and personalized reminder scheduling.",
      icon: Bot,
      status: "planned",
    ...
    },
    {
      ...
      description:
        "UX focused dashboards that give you clear visibility into your cash flow and outstanding payments.",
      icon: PieChart,
      status: "live",
  ...
  const benefits = [
    {
      ...
      description:
        "Automated reminders handle follow-ups so you can focus on your actual work",
      icon: Clock,
    },
    {
      title: "Professional Image",
      description:
        "Consistent, professional communication that builds trust with clients",
      icon: CheckCircle,
    },
    {
      title: "Better Cash Flow",
      description:
        "Get paid 75% faster on average with our systematic approach",
      icon: DollarSign,
    },
    {
      title: "Mobile-First Design",
      description:
        "Manage invoices on the go with our optimized mobile experience",
      icon: Smartphone,
    },
  ];
      ...
      <Suspense fallback={<div className="h-16 w-full bg-background" />}>
        <NavbarDemo>
            ...
            <div className="container mx-auto max-w-7xl">
              <div className="text-center mb-20 max-w-4xl mx-auto">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  From smart tracking to AI-powered reminders, we've got every
                  aspect of invoice management covered.
                </p>
              </div>
          ...
          <section className="py-24 px-4 md:px-6 bg-gradient-to-br from-blue-50/50 via-transparent to-indigo-50/50">
            <div className="container mx-auto max-w-7xl">
              <div className="text-center mb-20 max-w-4xl mx-auto">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Built specifically for freelancers and agencies who want to
                  focus on their craft, not chasing payments.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-white/90 to-slate-50/90 dark:from-slate-900/90 dark:to-slate-800/90 backdrop-blur-sm border border-border/50 rounded-2xl p-12">
                  ...
                  <p className="text-xl text-muted-foreground mb-10 leading-relaxed max-w-2xl mx-auto">
                    Transform invoice collection from a time-consuming burden
                    into a streamlined workflow that works while you sleep.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="lg"
                      className="font-medium text-lg border-2 hover:bg-muted/50 transition-all duration-300"
                    >
          ...
          <section id="pricing">
            <Suspense
              fallback={
                <div className="h-[600px] w-full animate-pulse bg-muted/50" />
              }
            >
              <LazyPricing />
            </Suspense>
