...
// Client component that receives prefetched data
export function InvoicesClient() {
  ...
  // Use custom hooks - now with prefetched data support
  const {
    invoices,
    filteredInvoices,
    isLoading,
  ...
  const isTrueLoading = isLoading && !invoices;
  ...
  return (
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      {/* Gmail Connection Banner - Only show if we have connection data */}
      {(isGmailConnected !== undefined || checkingGmailConnection) && (
