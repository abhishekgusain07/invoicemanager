            ...
            <div className="relative container max-w-7xl mx-auto py-16 px-6">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                        Seamlessly integrate your favorite tools to unlock powerful automation and streamline your invoice management workflow.
                    </p>
                </div>
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="relative">
                                        ...
                                        <div className="relative bg-gradient-to-br from-red-500 to-orange-500 p-4 rounded-3xl">
                                            <Image src="/gmail.svg" alt="Gmail" width={32} height={32} className="w-8 h-8 filter brightness-0 invert" />
                                        </div>
                                    </div>
                                    <div>
                            ...
                            {isConnected ? (
                                <div className="space-y-8">
                                    ...
                                    <div className="bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 rounded-2xl p-6">
                                        <div className="flex items-center gap-4 mb-4">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-semibold text-emerald-900">{connectionData?.email}</h3>
                                                <div className="flex items-center text-emerald-700 text-sm mt-1">
                                                    <Clock className="h-4 w-4 mr-2" />
                                                    Connected on {connectionData?.createdAt ? new Date(connectionData.createdAt).toLocaleDateString('en-US', { 
                                                        year: 'numeric', 
                                                        month: 'long', 
                                                        day: 'numeric' 
                                                    }) : ''}
                                        ...
                                        <p className="text-emerald-800 leading-relaxed">
                                            🎉 Perfect! Your Gmail account is successfully connected and ready to send professional invoice reminders automatically. 
                                            You're all set to streamline your payment collection process.
                                        </p>
                                    </div>
                                        ...
                                        {[
                                            {
                                                ...
                                                description: "Intelligent follow-up sequences based on invoice status and payment behavior."
                                            },
                                            {
                                                icon: Shield,
                                                title: "Secure & Private",
                                                description: "Bank-level encryption ensures your email credentials are completely secure."
                                            }
                                        ].map((feature, index) => (
                                            <div key={index} className="bg-white/60 border border-slate-200 rounded-xl p-4 hover:bg-white/80 transition-all duration-300">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <h3 className="text-2xl font-bold text-slate-900 mb-4">Ready to Automate Your Invoices?</h3>
                                        <p className="text-lg text-slate-600 max-w-xl mx-auto leading-relaxed">
                                            Connect your Gmail account to unlock powerful automation features and never chase a payment manually again.
                                        </p>
                                    </div>
                                        ...
                                        {[
                                            {
                                                ...
                                                description: "Send reminders instantly with just one click, or set up automatic sequences.",
                                                color: "from-yellow-400 to-orange-500"
                                            },
                                            {
                                                icon: Star,
                                                title: "Professional Templates",
                                                description: "Beautiful, customizable email templates that maintain your brand image.",
                                                color: "from-purple-400 to-pink-500"
                                            },
                                            {
                                                icon: TrendingUp,
                                                title: "Boost Collections",
                                                description: "Increase payment rates by up to 40% with timely, professional follow-ups.",
                                                color: "from-green-400 to-emerald-500"
                                            }
                                        ].map((feature, index) => (
                                            <div key={index} className="bg-white/60 border border-white/40 rounded-2xl p-6 hover:bg-white/80 transition-all duration-300 hover:scale-105">
                                                <div className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br ${feature.color} rounded-2xl mb-4 shadow-lg`}>
                                    ...
                                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <h4 className="font-semibold text-blue-900 mb-2">Enterprise-Grade Security</h4>
                                                <p className="text-blue-800 text-sm leading-relaxed">
                                                    We use OAuth 2.0 and bank-level encryption to protect your credentials. We never store your Gmail password, 
                            ...
                            <CardFooter className="relative bg-gradient-to-r from-slate-50 to-blue-50 border-t border-slate-200 px-8 py-6">
                                <div className="flex items-center justify-between w-full">
                                    <div className="flex items-center gap-3 text-sm text-slate-600">
                                        ...
                                        <span>Secure OAuth 2.0 connection - your credentials stay private</span>
                                    </div>
                                    {user && (
                                        <div className="flex items-center gap-4">
                                            ...
                                            <GmailConnect 
                                                ...
                                                onSuccess={() => {
                                                    setIsConnected(true);
                                                    toast.success("🎉 Gmail connected successfully! You're ready to automate your invoices.");
                                                }} 
                                            />
                                        </div>
                                    )}
                ...
                <div className="mt-16 text-center">
                    <h3 className="text-2xl font-bold text-slate-900 mb-8">More Integrations Coming Soon</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto">
                        {[
                            { name: "Slack", logo: "💬", color: "from-purple-400 to-pink-500" },
                            { name: "Zapier", logo: "⚡", color: "from-orange-400 to-red-500" },
                            { name: "QuickBooks", logo: "📊", color: "from-blue-400 to-indigo-500" },
                            { name: "Stripe", logo: "💳", color: "from-green-400 to-emerald-500" }
                        ].map((integration, index) => (
                            <div key={index} className="bg-white/40 border border-white/40 rounded-2xl p-4 text-center opacity-60">
                                <div className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br ${integration.color} rounded-2xl mb-3 text-2xl`}>
                                    {integration.logo}
                                </div>
                                <div className="font-medium text-slate-700">{integration.name}</div>
