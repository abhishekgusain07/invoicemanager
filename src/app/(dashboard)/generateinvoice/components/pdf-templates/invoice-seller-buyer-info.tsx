...
export const InvoiceSellerBuyerInfo = memo(function InvoiceSellerBuyerInfo({
  ...
  return (
    <View style={[PDF_DEFAULT_TEMPLATE_STYLES.flexRow, PDF_DEFAULT_TEMPLATE_STYLES.mb4]}>
      {/* Seller Information */}
      <View style={[{ width: "48%" }]}>
        ...
        <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.mediumText, PDF_DEFAULT_TEMPLATE_STYLES.boldText, PDF_DEFAULT_TEMPLATE_STYLES.mt2]}>
          {invoiceData.seller.name}
        </Text>
        
        <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.smallText, PDF_DEFAULT_TEMPLATE_STYLES.mt1]}>
        ...
        {invoiceData.seller.accountNumber && invoiceData.seller.accountNumberFieldIsVisible && (
          <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.smallText, PDF_DEFAULT_TEMPLATE_STYLES.mt1]}>
            Account: {invoiceData.seller.accountNumber}
          </Text>
        )}
        
        {invoiceData.seller.swiftBic && invoiceData.seller.swiftBicFieldIsVisible && (
          <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.smallText, PDF_DEFAULT_TEMPLATE_STYLES.mt1]}>
