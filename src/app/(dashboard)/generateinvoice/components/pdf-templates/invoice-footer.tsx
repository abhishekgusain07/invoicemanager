    ...
    <View style={[PDF_DEFAULT_TEMPLATE_STYLES.mt4]}>
      ...
      {invoiceData.notes && invoiceData.notesFieldIsVisible && (
        <View style={[PDF_DEFAULT_TEMPLATE_STYLES.mb3]}>
          ...
          <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.smallText, PDF_DEFAULT_TEMPLATE_STYLES.mt2]}>
            {invoiceData.notes}
          </Text>
        </View>
      )}
      ...
      {/* Signature Fields */}
      <View style={[PDF_DEFAULT_TEMPLATE_STYLES.flexRow, PDF_DEFAULT_TEMPLATE_STYLES.mt5]}>
        {/* Person Authorized to Issue */}
        {invoiceData.personAuthorizedToIssueFieldIsVisible && (
          <View style={[{ width: "48%" }]}>
            <View style={[PDF_DEFAULT_TEMPLATE_STYLES.borderT, PDF_DEFAULT_TEMPLATE_STYLES.mt5, PDF_DEFAULT_TEMPLATE_STYLES.pt2]}>
              <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.smallText, PDF_DEFAULT_TEMPLATE_STYLES.centerAlign]}>
                Person Authorized to Issue
              </Text>
            </View>
          </View>
      ...
      {/* Footer Note */}
      <View style={[PDF_DEFAULT_TEMPLATE_STYLES.mt5, PDF_DEFAULT_TEMPLATE_STYLES.centerAlign]}>
        <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.smallText, { color: "#666" }]}>
