    ...
    <View style={[PDF_DEFAULT_TEMPLATE_STYLES.mb4]}>
      ...
      <View style={[PDF_DEFAULT_TEMPLATE_STYLES.table]}>
        ...
        >
          ...
          <View
            style={[{ ...PDF_DEFAULT_TEMPLATE_STYLES.tableCol, width: "15%" }]}
          >
            <Text
              style={[
        ...
        {invoiceData.items.map((item, index) => (
          <View key={index} style={[PDF_DEFAULT_TEMPLATE_STYLES.tableRow]}>
            ...
            >
              <Text style={[PDF_DEFAULT_TEMPLATE_STYLES.descriptionCell]}>
                {item.name || "[Item Name]"}
              </Text>
            </View>
            <View
            ...
            <View
              style={[
                { ...PDF_DEFAULT_TEMPLATE_STYLES.tableCol, width: "15%" },
              ]}
            >
              <Text
                style={[
