...
export function TemplatePlaceholders() {
  const placeholders = [
    ...
    },
    {
      name: "invoice_amount",
      description:
        "Will be replaced with the formatted invoice amount (including currency)",
    },
    {
      name: "due_date",
    ...
    },
    {
      name: "days_overdue",
      description:
        "Will be replaced with the number of days the invoice is overdue",
    },
    {
      name: "invoice_link",
    ...
    <Card>
      <CardContent className="pt-6">
        ...
        <p className="text-muted-foreground mb-4">
          Use these placeholders in your templates to automatically personalize
          your emails
        </p>
        ...
        <div className="mt-6 pt-4 border-t text-sm text-muted-foreground">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <span className="font-medium">Subject:</span> Payment Reminder:
              Invoice #{"{invoice_number}"} is Overdue
            </li>
            <li>
              <span className="font-medium">Content:</span> Dear{" "}
              {"{client_name}"}, your invoice for {"{invoice_amount}"} was due
              on {"{due_date}"}.
            </li>
          </ul>
        </div>
