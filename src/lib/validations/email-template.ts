import { z } from "zod";
import { reminderToneEnum, templateTypeEnum, templateCategoryEnum } from "@/db/schema";
...
const templateCategoryEnumZ = z.enum(['reminder', 'thank_you', 'follow_up', 'notice', 'welcome', 'custom']);
