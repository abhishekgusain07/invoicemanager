    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Thank you for joining our exclusive waitlist! We're thrilled to have
          you as part of our growing community of early adopters.
        </Text>
        <Text style={paragraph}>
          We're putting the finishing touches on something special and you'll be
          among the first to know when we launch. Your interest means the world
          to us as we work to create the best possible experience.
        </Text>
        <Text style={paragraph}>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          You're receiving this because you signed up for our waitlist. Not
          interested? No problem, you can unsubscribe anytime.
        </Text>
      </Container>
    </Body>
  </Html>
