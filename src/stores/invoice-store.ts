...
import {
  ...
  EMPTY_INVOICE_DATA,
} from "../app/(dashboard)/generateinvoice/constants";
          ...
          try {
            ...
            if (validationResult.success) {
              ...
              if (process.env.NODE_ENV === "development") {
                console.warn(
                  "Saving unvalidated invoice data:",
            ...
            console.error(
              "Failed to save invoice data to localStorage:",
              error
            );
          ...
          try {
            ...
            if (savedData) {
              ...
              if (validationResult.success) {
                ...
                console.warn(
                  "Saved invoice data failed validation, using defaults:",
                  validationResult.error
                );
                set({
...
export const useInvoiceData = () =>
  useInvoiceStore((state) => state.invoiceData);
export const useIsLoading = () => useInvoiceStore((state) => state.isLoading);
export const useCanShareInvoice = () =>
  useInvoiceStore((state) => state.canShareInvoice);
export const useCurrentInvoiceId = () =>
  useInvoiceStore((state) => state.currentInvoiceId);
export const useIsInitialized = () =>
  useInvoiceStore((state) => state.isInitialized);
